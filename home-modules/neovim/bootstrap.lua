...
require('lazy').setup({
  ...
  --  The configuration is done below. Search for lspconfig to find it below.
  {
    ...
    config = function()
      ...
      lsp.setup_servers(get_server_names())
    ...
    dependencies = {
      ...
      { "folke/neodev.nvim", opts = {} },          -- Required
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'lua', 'nix', 'python', 'haskell', 'vimdoc', 'vim' },
...
for k, v in pairs(get_server_configs()) do
